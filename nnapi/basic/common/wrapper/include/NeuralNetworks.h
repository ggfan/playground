 ...
 */
extern int (*ANeuralNetworksInitialize)();
 ...
 */
extern void (*ANeuralNetworksShutdown)();
 ...
 */
extern int (*ANeuralNetworksMemory_createShared)(size_t size, ANeuralNetworksMemory** memory);
 ...
 */
extern int (*ANeuralNetworksMemory_getPointer)(ANeuralNetworksMemory* memory, uint8_t** buffer);
 ...
 */
extern void (*ANeuralNetworksMemory_free)(ANeuralNetworksMemory* memory);
 ...
 * @return ANEURALNETWORKS_NO_ERROR if successful.
 */
extern int (*ANeuralNetworksModel_create)(ANeuralNetworksModel** model);
 ...
 */
extern void (*NeuralNetworksModel_free)(ANeuralNetworksModel* model);
 ...
 * @return ANEURALNETWORKS_NO_ERROR if successful.
 */
extern int (*ANeuralNetworksModel_addOperand)(ANeuralNetworksModel* model,
 ...
 * @return ANEURALNETWORKS_NO_ERROR if successful.
 */
extern int (*ANeuralNetworksModel_setOperandValue)(ANeuralNetworksModel* model, int32_t index,
 ...
 * @return ANEURALNETWORKS_NO_ERROR if successful.
 */
extern int (*ANeuralNetworksModel_setOperandValueFromMemory)(ANeuralNetworksModel* model, int32_t index,
 ...
 * @return ANEURALNETWORKS_NO_ERROR if successful.
 */
extern int (*ANeuralNetworksModel_addOperation)(ANeuralNetworksModel* model,
 ...
 * {@link ANeuralNetworksRequest_create}.
 */
extern int (*ANeuralNetworksModel_setInputsAndOutputs)(ANeuralNetworksModel* model,
                                             ANeuralNetworksIntList* inputs,
                                             ANeuralNetworksIntList* outputs);
 ...
 */
extern int (*ANeuralNetworksRequest_create)(ANeuralNetworksModel* model, ANeuralNetworksRequest** request);
 ...
 *                results in no operation.
 */
extern void (*ANeuralNetworksRequest_free)(ANeuralNetworksRequest* request);
 ...
 * @return ANEURALNETWORKS_NO_ERROR if successful.
 */
extern int (*ANeuralNetworksRequest_setPreference)(ANeuralNetworksRequest* request, uint32_t preference);
 ...
 */
extern int (*ANeuralNetworksRequest_setInput)(ANeuralNetworksRequest* request, int32_t index,
 ...
 *         name is not recognized or the buffer is too small for the input.
 */
extern int (*ANeuralNetworksRequest_setInputFromMemory)(ANeuralNetworksRequest* request, int32_t index,
                                              const ANeuralNetworksOperandType* type,
 ...
 */
extern int (*ANeuralNetworksRequest_setOutput)(ANeuralNetworksRequest* request, int32_t index,
 ...
 *         name is not recognized or the buffer is too small for the output.
 */
extern int (*ANeuralNetworksRequest_setOutputFromMemory)(ANeuralNetworksRequest* request, int32_t index,
                                               const ANeuralNetworksOperandType* type,
                                               const ANeuralNetworksMemory* memory, uint32_t offset,
                                               uint32_t length);
 ...
 * @return ANEURALNETWORKS_NO_ERROR if successful.
 */
extern int (*ANeuralNetworksRequest_startCompute)(ANeuralNetworksRequest* request,
 ...
 * @return ANEURALNETWORKS_NO_ERROR if the request completed normally.
 */
extern int (*ANeuralNetworksEvent_wait)(ANeuralNetworksEvent* event);
 ...
 * event.
 */
extern void (*ANeuralNetworksEvent_free)(ANeuralNetworksEvent* event);


/**
 * Initialize NNAPI function pointers
 * @return negative value when failed to load; other values for success
 */
