...
public class WideColorActivity extends NativeActivity {
    ...
    TextView _p3Image, _sRGBImage, _welcome;
    ...
    public void EnableUI(final int mask)
    {
        ...
        this.runOnUiThread(new Runnable()  {
            ...
            public void run()  {
                ...
                _welcome = (TextView)popupView.findViewById(R.id.textViewWelcome);
    ...
    public void EnableRenderUI() {
        this.runOnUiThread(new Runnable()  {
            @Override
            public void run() {
                _welcome.setVisibility(View.GONE);
                _p3Image.setVisibility(View.VISIBLE);
                _sRGBImage.setVisibility(View.VISIBLE);
            }});
    }

    public void UpdateUI(final int mask)
    {
        _activity = this;
        this.runOnUiThread(new Runnable()  {
            @Override
            public void run()  {
                ...
                if(_sRGBImage != null) {
                    _sRGBImage.setVisibility((mask & 2) == 2 ? View.VISIBLE : View.INVISIBLE);
                }
            }});
    }
