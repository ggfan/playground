...
class MainActivity : AppCompatActivity() {
    ...
    private fun startCamera() {
        ...
        cameraProviderFuture.addListener(Runnable {
            ...
            val cameraSelector = CameraSelectorAdapter.selectBestCamera2(cameraProvider) ?: throw IllegalArgumentException()
            ...
            try {
                ...
                cameraProvider.bindToLifecycle(this, cameraSelector, preview, videoCapturer)
